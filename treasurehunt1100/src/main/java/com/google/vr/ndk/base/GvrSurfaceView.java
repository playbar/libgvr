...
import com.google.vr.cardboard.EglReadyListener.EventListener;
...
public class GvrSurfaceView extends SurfaceView implements Callback2 {
    ...
    static class GLThread extends Thread implements EventListener {
        ...
        GLThread(WeakReference<GvrSurfaceView> var1) {
            ...
            if((var2 = (GvrSurfaceView)var1.get()) != null && var2.mAppContextListener != null) {
                var2.mAppContextListener.setEventListener(this);
            }
        ...
        public void requestExitAndWait() {
            ...
            synchronized(this.mGLThreadManager) {
                ...
                if((var2 = (GvrSurfaceView)this.mGvrSurfaceViewWeakRef.get()) != null && var2.mAppContextListener != null) {
                    var2.mAppContextListener.releaseEventListener();
                }
    ...
    static class EglHelper {
        ...
        private void createPendingEglContext() {
            ...
            if(this.mPendingEglDisplay == EGL10.EGL_NO_DISPLAY) {
                ...
                int[] var1 = new int[2];
                if(!this.mEgl.eglInitialize(this.mPendingEglDisplay, var1)) {
                    throw new RuntimeException("eglInitialize failed");
                } else {
                    EGLContext var2;
                    GvrSurfaceView var3;
                    if((var3 = (GvrSurfaceView)this.mGvrSurfaceViewWeakRef.get()) == null) {
                        this.mEglConfig = null;
                        var2 = null;
                    } else {
                        if(var3.mAppContextListener != null) {
                            EGLContext var4;
                            if((var4 = var3.mAppContextListener.getEGLContext()) != null && var4 != EGL10.EGL_NO_CONTEXT) {
                                EglFactory var5 = (EglFactory)var3.mEGLContextFactory;
                                int var6 = var3.mAppContextListener.getEGLContextFlags();
                                var5.setSharedContext(var4);
                                var5.setErrorReportingEnabled((var6 & 8) == 0);
                                var5.setEGLContextClientVersion(var3.mAppContextListener.getGLVersion());
                            } else {
                                this.throwEglException("Unable to obtain application's OpenGL context.");
                            }
                        }

                        this.mEglConfig = var3.mEGLConfigChooser.chooseConfig(this.mEgl, this.mPendingEglDisplay);
                        var2 = var3.mEGLContextFactory.createContext(this.mEgl, this.mPendingEglDisplay, this.mEglConfig);
                    }

                    if(var2 == null || var2 == EGL10.EGL_NO_CONTEXT) {
                        var2 = null;
                        int var7;
                        if((var7 = this.mEgl.eglGetError()) == 12294) {
                            Log.e("EglHelper", "Stashed EGL context has become invalid and can no longer be used for sharing.");
                            this.mPendingEglContext = null;
                            this.mPendingEglDisplay = null;
                            this.mEglConfig = null;
                            if(var3.mAppContextListener != null) {
                                var3.mAppContextListener.clearContext();
                            }

                            return;
                        }

                        throwEglException("createPendingEglContext", var7);
                    }

                    this.mPendingEglContext = var2;
                }
            }
        }
        ...
        public static String formatEglError(String var0, int var1) {
            String var2 = getErrorString(var1);
    ...
    class SimpleEGLConfigChooser extends GvrSurfaceView.ComponentSizeChooser {
        public SimpleEGLConfigChooser(boolean var2) {
            super(8, 8, 8, 0, var2?16:0, 0);
        }
    }

    class ComponentSizeChooser extends GvrSurfaceView.BaseConfigChooser {
    ...
    class DefaultContextFactory implements EGLContextFactory {
        ...
        public void destroyContext(EGL10 var1, EGLDisplay var2, EGLContext var3) {
            if(!var1.eglDestroyContext(var2, var3)) {
                ...
                GvrSurfaceView.EglHelper.throwEglException("eglDestroyContext", var1.eglGetError());
            }
