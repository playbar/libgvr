...
public class DaydreamApi implements AutoCloseable {
    ...
    public static boolean isVrUser(Context var0) {
        VrParamsProvider var1 = VrParamsProviderFactory.create(var0);

        try {
            if(var1.readDeviceParams() == null) {
                return false;
            }
        } finally {
            var1.close();
    ...
    public static boolean getDaydreamSetupCompleted(Context var0) {
        return getBooleanSetting(var0, "daydream_setup", false);
    }

    public static boolean isDashboardEnabled(Context var0) {
        return getBooleanSetting(var0, "dashboard_enabled", false);
    }

    private static boolean getBooleanSetting(Context var0, String var1, boolean var2) {
        ContentProviderClientHandle var3;
        if((var3 = VrParamsProviderFactory.tryToGetContentProviderClientHandle(var0)) == null) {
            String var10000 = TAG;
            String var10002 = String.valueOf(var1);
            String var10001 = "No ContentProvider available for";
            if(var10002.length() != 0) {
                var10001 = "No ContentProvider available for ".concat(var10002);
            } else {
//                String var10003 = new String;
//                var10001 = var10003;
//                var10003.<init>("No ContentProvider available for ");
            }
            ...
            try {
                Uri var5 = VrSettingsProviderContract.createUri(var3.authority, var1);
                if((var4 = var3.client.query(var5, (String[])null, (String)null, (String[])null, (String)null)) != null && var4.moveToFirst()) {
                    boolean var6 = var4.getInt(0) == 1;
                    return var6;
                }

                return var2;
            } catch (RemoteException var11) {
                Log.e(TAG, (new StringBuilder(42 + String.valueOf(var1).length())).append("Failed to read ").append(var1).append(" state from ContentProvider").toString(), var11);
                return var2;
            } catch (SecurityException var12) {
                Log.e(TAG, (new StringBuilder(60 + String.valueOf(var1).length())).append("Insufficient permissions to read ").append(var1).append(" state from ContentProvider").toString(), var12);
            } finally {
                if(var4 != null) {
                    var4.close();
                }
        ...
        this.runWhenServiceConnected(new Runnable() {
            public void run() {
                if(DaydreamApi.this.vrCoreApiVersion < 11) {
                    String var10000 = DaydreamApi.TAG;
                    String var1x = "Can't handle insertion of phone into headset: VrCore API too old. Need: 11, found: ";
    ...
    public void handleRemovalFromHeadset() {
        this.runWhenServiceConnected(new Runnable() {
            public void run() {
                if(DaydreamApi.this.vrCoreApiVersion < 11) {
                    String var10000 = DaydreamApi.TAG;
                    String var1 = "Can't handle removal of phone from headset: VrCore API too old. Need: 11, found: ";
                    int var2 = DaydreamApi.this.vrCoreApiVersion;
    ...
    public static void setVrContentIntent(Bundle var0) {
        var0.putBoolean("vrContentIntent", true);
    }

    public static boolean hasVrContentIntent(Bundle var0) {
        return var0.getBoolean("vrContentIntent");
    }
...
//            }
    ...
    protected void runWhenServiceConnected(Runnable var1) {
    ...
    protected IDaydreamManager getDaydreamManager() {
