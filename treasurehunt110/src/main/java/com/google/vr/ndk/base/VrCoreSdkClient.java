...
class VrCoreSdkClient {
    ...
    static final int TARGET_VRCORE_API_VERSION = 21;
    ...
    private final ServiceConnection serviceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName var1, IBinder var2) {
            ...
            label184: {
                String var6;
                label202: {
                    HeadTrackingState var23;
                    int var24;
                    label182: {
                        try {
                            var17 = true;
                            var23 = VrCoreSdkClient.this.getHeadTrackingState();
                            if(VrCoreSdkClient.this.vrCoreClientApiVersion >= 13) {
                                ...
                                if((var8 = VrCoreSdkClient.this.optionalReentryIntent) == null) {
                                    ...
                                    Activity var10;
                                    if(!(VrCoreSdkClient.this.context instanceof VrContextWrapper) && (var10 = ContextUtils.getActivity(VrCoreSdkClient.this.context)) != null && var10.getIntent() != null) {
                                        var9.putExtras(var10.getIntent());
                                        var9.fillIn(var10.getIntent(), 2);
                                    }

                                    var8 = PendingIntent.getActivity(VrCoreSdkClient.this.context, 0, var9, 1073741824);
                                }

                                var24 = VrCoreSdkClient.this.daydreamManager.prepareVr2(VrCoreSdkClient.this.componentName, var7, var8, var23);
                            } else {
                                ...
                                var24 = VrCoreSdkClient.this.daydreamManager.prepareVr(VrCoreSdkClient.this.componentName, var23);
                            }
    ...
    static final class DaydreamListenerImpl extends com.google.vr.vrcore.common.api.IDaydreamListener.Stub {
        ...
        public final void applyFade(int var1, long var2) {
            this.applyColorfulFadeImpl(var1, var2, -16777216);
        }

        public final void applyColorfulFade(int var1, long var2, int var4) {
            this.applyColorfulFadeImpl(var1, var2, var4);
        }
        ...
        private final void applyColorfulFadeImpl(final int var1, final long var2, final int var4) {
            final FadeOverlayView var5;
            if((var5 = (FadeOverlayView)this.fadeOverlayViewWeak.get()) != null) {
                this.cancelSafeguard(2);
                var5.post(new Runnable() {
                    public void run() {
                        var5.startFade(var1, var2, var4);
                    }
                });
                if(var1 == 2) {
