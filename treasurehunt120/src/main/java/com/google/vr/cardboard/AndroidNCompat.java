...
public class AndroidNCompat {
    ...
    private static int checkForVrCorePresence(Context var0) {
        ...
        while(var3.hasNext()) {
            if(((ApplicationInfo)var3.next()).packageName.equals("com.google.vr.vrcore")) {
                var2 = true;
                break;
            }
        }
        ...
        if(!var2) {
            ...
            ComponentName var4 = new ComponentName("com.google.vr.vrcore", "com.google.vr.vrcore.common.VrCoreListenerService");
            return var5 != null && var5.contains(var4.flattenToString())?0:0;
        }
    }
