...
public final class VrCoreUtils {
    ...
    public static int getVrCoreClientApiVersion(Context var0) throws VrCoreNotAvailableException {
        try {
            ...
            if((var1 = var0.getPackageManager().getApplicationInfo("com.google.vr.vrcore", 128)).enabled) {
    ...
    public static int getVrCoreVersionCode(Context var0) throws VrCoreNotAvailableException {
        try {
            return var0.getPackageManager().getPackageInfo("com.google.vr.vrcore", 0).versionCode;
        } catch (NameNotFoundException var2) {
    ...
    public static String getVrCoreVersionName(Context var0) throws VrCoreNotAvailableException {
        try {
            return var0.getPackageManager().getPackageInfo("com.google.vr.vrcore", 0).versionName;
        } catch (NameNotFoundException var2) {
            Log.e(TAG, "Could not find VrCore package", var2);
            throw new VrCoreNotAvailableException(checkVrCoreAvailability(var0));
        }
    ...
    public static String getVrCoreSdkLibraryVersion(Context var0) throws VrCoreNotAvailableException {
        ApplicationInfo var1;
        try {
            var1 = var0.getPackageManager().getApplicationInfo("com.google.vr.vrcore", 128);
    ...
    public static boolean isVrCorePackage(String var0) {
        return "com.google.vr.vrcore".equalsIgnoreCase(var0);
    }
    ...
    private static int checkVrCoreAvailabilityImpl(Context var0) {
        if("com.google.vr.vrcore".equals(var0.getPackageName())) {
            ...
            try {
                return !var0.getPackageManager().getApplicationInfo("com.google.vr.vrcore", 0).enabled?2:(!verifyRemotePackageSignature(var0)?9:0);
                ...
                if(VERSION.SDK_INT >= 21) {
                    ...
                    while(var2.hasNext()) {
                        ...
                        if("com.google.vr.vrcore".equals(var3.getAppPackageName())) {
                            return 3;
                        }
                    }
                }
                ...
                try {
                    if(var1.getApplicationInfo("com.google.vr.vrcore", 8192).enabled) {
                        return 3;
                    }
    ...
    private static boolean verifyRemotePackageSignature(Context var0) throws NameNotFoundException {
        PackageInfo var1;
        return SignatureUtils.verifySignature(var1 = var0.getPackageManager().getPackageInfo("com.google.vr.vrcore", 64), new Signature[]{SignatureUtils.VRCORE_RELEASE_SIGNATURE})?true:(BuildUtils.isDebugBuild(var0)?SignatureUtils.verifySignature(var1, new Signature[]{SignatureUtils.VRCORE_DEBUG_SIGNATURE}):false);
    }
