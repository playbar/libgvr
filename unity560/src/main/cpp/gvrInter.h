...
//int gvr_buffer_viewport_get_transform(int a1, int a2);
...
//int gvr_controller_state_get_position(int a1, int a2);
...
//int64_t gvr_controller_state_get_last_position_timestamp( int a1);
