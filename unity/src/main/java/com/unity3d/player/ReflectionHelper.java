...
final class ReflectionHelper {
    ...
    protected static Method getMethodID(Class var0, String var1, String var2, boolean var3) {
        ...
        if(var4 == null) {
            throw new NoSuchMethodError(String.format("no %s method with name=\'%s\' signature=\'%s\' in class L%s;", new Object[]{var3?"static":"non-static", var1, var2, var0.getName()}));
        } else {
            return var4;
        }
    }
    ...
    protected static Field getFieldID(Class var0, String var1, String var2, boolean var3) {
        ...
        if(var4 == null) {
            throw new NoSuchFieldError(String.format("no %s field with name=\'%s\' signature=\'%s\' in class L%s;", new Object[]{var3?"static":"non-static", var1, var2, var0.getName()}));
        } else {
            return var4;
        }
    }
