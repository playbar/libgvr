...
public class GvrUiLayout extends FrameLayout {
    ...
    GvrUiLayout(Context var1, DaydreamUtilsWrapper var2) {
        ...
        Log.i("DebugGvr" , "GvrUiLayout init");
    ...
    private static Runnable createDefaultCloseButtonRunnable(Context var0, DaydreamUtilsWrapper var1) {
        Log.i("DebugGvr" , "GvrUiLayout createDefaultCloseButtonRunnable");
        final Activity var2;
        return (var2 = ContextUtils.getActivity(var0)) == null ? null : (var1.isDaydreamActivity(var2) ? new Runnable() {
            public final void run() {
                Log.i("DebugGvr" , "GvrUiLayout start Home");
                Intent var1;
            ...
            public final void run() {
                Log.i("DebugGvr" , "GvrUiLayout onBackPressed");
                var2.onBackPressed();
            }
        });
    }
