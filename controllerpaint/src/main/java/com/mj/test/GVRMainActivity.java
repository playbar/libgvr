 ...
 */
public class GVRMainActivity extends Activity {
  private static final String TAG = "GVRMainActivity";
  // Opaque native pointer to the DemoApp C++ object.
  // This object is owned by the GVRMainActivity instance and passed to the native methods.
  ...
  {
    // Load our JNI code.
    System.loadLibrary("controllerpaint");
  }
