...
import com.google.vr.ndk.base.DaydreamAlignment.DefaultTouchListener;
...
public class GvrLayout extends FrameLayout {
    ...
    public GvrLayout(Context var1) {
        super(var1);
        this.init((GvrApi)null, (DisplaySynchronizer)null, (FadeOverlayView)null, (DaydreamUtilsWrapper)null);
    }
    ...
    GvrLayout(Context var1, GvrApi var2, DisplaySynchronizer var3, FadeOverlayView var4, DaydreamUtilsWrapper var5) {
        super(var1);
        this.init(var2, var3, var4, var5);
    }

    private void init(GvrApi var1, DisplaySynchronizer var2, FadeOverlayView var3, DaydreamUtilsWrapper var4) {
        Activity var5;
        if((var5 = ContextUtils.getActivity(this.getContext())) == null) {
            ...
            try {
                ...
                var4 = var4 != null?var4:new DaydreamUtilsWrapper();
                ...
                this.updateUiLayout();
                boolean var6;
                if(var6 = var4.isDaydreamPhone(this.getContext())) {
                    this.daydreamAlignment = this.createDaydreamAlignment();
                    this.uiLayout.setOnTouchListener(new DefaultTouchListener(this.daydreamAlignment, var1));
                }

                int var7;
                boolean var8 = (var7 = var4.getActivityDaydreamCompatibility(var5)) != 0;
                boolean var9 = var7 == 2;
                if(var6 || var9) {
                    if(var8) {
                        this.fadeOverlayView = var3 != null?var3:new FadeOverlayView(this.getContext());
    ...
    protected VrCoreSdkClient createVrCoreSdkClient(Context var1, GvrApi var2, DaydreamUtilsWrapper var3, FadeOverlayView var4) {
        ComponentName var5 = ContextUtils.getActivity(var1).getComponentName();
    ...
    public void setStereoModeEnabled(boolean var1) {
        if(this.stereoModeEnabled != var1) {
            ...
            if(this.daydreamAlignment != null) {
                this.daydreamAlignment.setEnabled(var1);
            }
    ...
    private static class PresentationHelper implements DisplayListener {
        ...
        private boolean isValidExternalDisplay(Display var1) {
            return var1.isValid() && var1.getName().equals(this.externalDisplayName);
        }
