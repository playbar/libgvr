...
class WWW extends Thread {
    ...
    public void runSafe() {
        if(++this.a > 5) {
            ...
            URLConnection var2;
            try {
                var2 = (var1 = new URL(this.c)).openConnection();
            ...
            if(var1.getProtocol().equalsIgnoreCase("file") && var1.getHost() != null && var1.getHost().length() != 0) {
                ...
                if(this.d != null) {
                    ...
                    try {
                        OutputStream var18 = var2.getOutputStream();
                        var5 = 0;

                        while(var5 < this.d.length) {
                            int var6 = Math.min(1428, this.d.length - var5);
                            var18.write(this.d, var5, var6);
                ...
                if(var2 instanceof HttpURLConnection) {
                    ...
                    List var8;
                    Map var24;
                    if((var24 = var20.getHeaderFields()) != null && (var5 == 301 || var5 == 302) && (var8 = (List)var24.get("Location")) != null && !var8.isEmpty()) {
                        var20.disconnect();
                ...
                Map var21 = var2.getHeaderFields();
                boolean var23 = this.headerCallback(var21);
                if((var21 == null || !var21.containsKey("content-length")) && var2.getContentLength() != -1) {
                    var23 = var23 || this.headerCallback("content-length", String.valueOf(var2.getContentLength()));
                }

                if((var21 == null || !var21.containsKey("content-type")) && var2.getContentType() != null) {
                    var23 = var23 || this.headerCallback("content-type", var2.getContentType());
                }

                if(var23) {
                    errorCallback(this.b, this.c + " aborted");
                } else {
                    int var22 = var2.getContentLength() > 0?var2.getContentLength():0;
                    if(var1.getProtocol().equalsIgnoreCase("file") || var1.getProtocol().equalsIgnoreCase("jar")) {
                        var17 = var22 == 0?'耀':Math.min(var22, '耀');
                    }
                    ...
                    try {
                        ...
                        while(true) {
                            ...
                            if(this.readCallback(var26, var27)) {
                                errorCallback(this.b, this.c + " aborted");
                                return;
                            }
                            ...
                            if(!var19) {
                                var5 += var27;
                                this.progressCallback(0, 0, var5, var22, System.currentTimeMillis(), var25);
                            }

                            var27 = var16.read(var26);
                        }
