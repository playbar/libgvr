...
public class GvrApi {
    ...
    public GvrApi(Context var1, DisplaySynchronizer var2) {
        ...
        this.nativeGvrContext = this.nativeCreate(this.getClass().getClassLoader(), var1.getApplicationContext(), var3,
                var5.widthPixels, var5.heightPixels, var5.xdpi, var5.ydpi, null);
//        this.nativeGvrContext = this.nativeCreate(this.getClass().getClassLoader(), var1.getApplicationContext(), var3,
//                var5.widthPixels, var5.heightPixels, var5.xdpi, var5.ydpi, sPoseTrackerForTesting);
    }
    ...
    public long getNativeCardboardApi() {
        return this.nativeGetCardboardApi(this.nativeGvrContext);
    }
    ...
    public void updateSurfaceReprojectionThread(int var1, int var2, long var3, float[] var5) {
        this.nativeUpdateSurfaceReprojectionThread(this.nativeGvrContext, var1, var2, var3, var5);
    }
    ...
    public void resumeTracking() {
        this.nativeResumeTracking(this.nativeGvrContext, (byte[])null);
    }
    ...
    public void resumeTrackingSetState(byte[] var1) {
        if(var1 == null) {
            ...
            this.nativeResumeTracking(this.nativeGvrContext, var1);
        }
    }
    ...
    public float[] getEyeFromHeadMatrix(int var1) {
        float[] var2;
        if((var2 = this.nativeGetEyeFromHeadMatrix(this.nativeGvrContext, var1)).length != 16) {
    ...
    public DisplayMetrics computeCurrentDisplayMetrics() {
        ...
        return DisplayUtils.getDisplayMetricsWithOverride(var1, this.vrParamsProvider.readPhoneParams());
    }

    public void setDisplayMetrics(DisplayMetrics var1) {
    ...
    private native long nativeGetCardboardApi(long var1);
    ...
    private native void nativeUpdateSurfaceReprojectionThread(long var1, int var3, int var4, long var5, float[] var7);

    private native void nativeRemoveAllSurfacesReprojectionThread(long var1);
    ...
    private native byte[] nativePauseTracking(long var1);

    private native void nativeResumeTracking(long var1, byte[] var3);

    private native void nativeResetTracking(long var1);

    private native void nativeRecenterTracking(long var1);

    private native float[] nativeGetEyeFromHeadMatrix(long var1, int var3);
